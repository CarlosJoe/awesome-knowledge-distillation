...
from train import train_teacher, distill_train_overhaul, train_student_baseline
...
def main():
    ...
    print("=" * 60)
    print("CIFAR-10 Overhaul 特征蒸馏实验")
    print("=" * 60)
    ...
    overhaul_student = distill_train_overhaul(config, teacher_model, train_loader, test_loader, device)
